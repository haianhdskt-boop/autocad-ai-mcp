...
def cad_ve_moi(
    ...
    Vẽ trực tiếp mặt bằng kiến trúc mới lên AutoCAD for Mac theo đúng phân lớp layer chuẩn:
...
def cad_chinh_sua(
    ...
    Thực hiện các thao tác sửa đổi, co giãn, dịch chuyển mảng tường và cửa trực tiếp trên AutoCAD for Mac:
    - action:
    ...
    ACTION_MAP = {
        ...
        "move_wall": "move",
        "mirror_door": "mirror",
        "rotate_object": "mirror",  # Handled via axis rotation in mirror
        "change_layer": "change_layer",
        "delete_object": "delete",
        # Allow direct modifier action names too
        "move": "move",
        "stretch": "stretch",
    ...
    # Pack keyword arguments into parameters dict expected by modifier
    parameters = {
        "dx": dx,
        "dy": dy,
