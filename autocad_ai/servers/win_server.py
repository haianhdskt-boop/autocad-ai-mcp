...
mcp = FastMCP(
    name="autocad-ai-win",
    instructions="AutoCAD AI Professional Architect Suite (Windows COM): 6 core business commands for live drafting, modification, multi-sheet construction documentation, detailed BOQ estimation, and drawing inspection.",
)
