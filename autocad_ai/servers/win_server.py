...
mcp = FastMCP(
    name="autocad-ai-win",
    instructions="AutoCAD AI Professional Architect Suite (Windows COM): 7 core business commands for live drafting, modification, multi-sheet construction documentation, detailed BOQ estimation, inspection, and standardized PDF plotting.",
)
